...
if (!client.includes("restorePremiumPurchases") || !page.includes("handleRestore") || !page.includes("processAndVerifyPurchaseToken")) throw new Error("restore migration missing");
