// ONE-TIME MIGRATION DATA — legacy hardcoded tester registry, verbatim from git history
// (lib/billing/founderTesterSourceOfTruth.ts before the PII remediation removed it).
// Used ONLY by scripts/migrations/migrateTesterBadgeRegistry.ts — never imported by the app.
// DO NOT import this file from anywhere under app/, components/, or lib/.
...
export const LEGACY_FOUNDER_TESTER_RECORDS: FounderTesterRecord[] = [
