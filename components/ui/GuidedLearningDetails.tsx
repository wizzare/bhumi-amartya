...
export function GuidedLearningDetails({
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        <p className="text-xs font-bold uppercase tracking-wider text-[#9AA394]">
          {isEn ? "How to practice" : "Cara Melakukan"}
        </p>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl bg-[#FCFAF5] p-4">
          <p className="text-xs font-bold uppercase tracking-wider text-[#9AA394]">
            {isEn ? "For beginners" : "Untuk Pemula"}
          </p>
          <p className="mt-1 text-sm font-semibold text-[#4F5E52]">
            {beginnerFriendly
              ? (isEn ? "Yes. Start slowly and pause if it feels uncomfortable." : "Ya. Mulai perlahan dan berhenti jika terasa tidak nyaman.")
              : (isEn ? "Requires prior experience or guidance." : "Perlu pengalaman atau pendampingan.")}
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-[#E8E9E5] bg-white p-4">
        <p className="text-xs font-bold uppercase tracking-wider text-[#9AA394]">
          {isEn ? "Visual Learning Resources" : "Sumber Belajar Visual"}
        </p>
