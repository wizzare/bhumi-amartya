  ...
  return (
    <section className="rounded-[32px] bg-[#F5F5F2] p-7 shadow-soft border border-[#E8E9E5]">
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="text-[#7B8776] text-xs uppercase tracking-[0.24em] mb-2">{isEn ? "Mudra Guide" : "Panduan mudra"}</p>
      ...
      <div className="mt-5 rounded-[24px] bg-white p-5 border border-[#E8E9E5]">
        <p className="text-[#7B8776] text-xs uppercase tracking-[0.24em] mb-2">{isEn ? "Benefits" : "Manfaat"}</p>
