  ...
  return (
    <section className="rounded-[32px] bg-[#F4F2EC] p-7 shadow-soft">
      <div className="flex flex-col gap-3">
        <p className="text-[#8B9488] uppercase text-xs tracking-[0.24em]">{isEn ? "Healing Theme" : "Tema penyembuhan"}</p>
      ...
      <div className="mt-6 rounded-[24px] border border-[#E8E9E5] bg-white p-5">
        <p className="text-[#7B8776] text-xs uppercase tracking-[0.24em] mb-2">{isEn ? "Your Focus" : "Fokus Kamu"}</p>
