...
export function AncestorHealingCard({
  ...
  return (
    <section className="rounded-[32px] bg-[#F7F3EE] p-7 shadow-soft border border-[#E8E9E5]">
      <p className="text-[#7B8776] text-xs uppercase tracking-[0.24em] mb-2">{isEn ? "Ancestral Care" : "Kepedulian leluhur"}</p>
      <h2 className="text-2xl font-semibold text-[#3E4A43]">{isEn ? "The lineage supporting you" : "Garis keturunan yang menopangmu"}</h2>
      ...
      <div className="mt-6 rounded-[24px] bg-white p-5 border border-[#E8E9E5]">
        <p className="text-[#7B8776] text-xs uppercase tracking-[0.24em] mb-2">{isEn ? "Lineage Notes" : "Catatan garis keturunan"}</p>
