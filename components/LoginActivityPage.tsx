...
export function LoginActivityPage({ embedded = false }: Props){
  ...
  return <div className={embedded ? '' : 'page'}>
    {embedded ? (
      <div className="toolbar" style={{justifyContent:'space-between',marginBottom:12}}>
        <span className="source-badge">USER ACTIVITY · SHARED CACHE</span>
        <button className="btn" onClick={()=>void refresh()}>Refresh Activity</button>
      </div>
    ) : (
