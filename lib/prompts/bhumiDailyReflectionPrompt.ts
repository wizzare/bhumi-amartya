...
export function buildBhumiDailyReflectionPrompt(
  ...
  return {
    ...
    criticalRules: [
      ...
      "End with exactly one concrete reflection or practical focus. Do not add action lists, multiple recommendations, or extra paragraphs.",
      "PRECISION OVER VOLUME: Keep the existing length contract. If a detail does not make the note more personal, contextual, or practical, omit it.",
