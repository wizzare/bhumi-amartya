...
export function buildBhumiManifestationPrompt(
  ...
  return {
    role: isEn ? "Bhumi Manifestation writer" : "Bhumi Manifestation (Manifestasi Hari Ini) writer",
    identity:
    ...
    objective: isEn
      ? "Transform Daily Manifestation into a dynamic companion that evolves with the user's journey, blueprint, and today's cosmic context."
    ...
    requiredEngineBehavior: {
      ...
      contextAwareness: isEn
        ? "Ensure the manifestation aligns with today's Soul Reflection essence and Today's Note themes."
        : "Ensure the manifestation aligns with today's Refleksi Jiwa essence and Catatan Hari Ini themes.",
    ...
    criticalRules: [
      isEn
        ? "Keep statements in first person ('I') as they are meant to be repeated by the user."
