...
const PLANET_HOUSE_MOVEMENTS: Record<string, Record<number, string>> = {
  ...
  Jupiter: {
    ...
    8: "simbol Jupiter di posisi ini dapat menjadi bahan refleksi tentang rasa percaya dan dukungan emosional yang kamu butuhkan.",
  ...
  Uranus: {
    ...
    8: "simbol Uranus di posisi ini dapat mengajakmu melihat pola keterikatan lama dari sudut pandang yang lebih baru.",
    ...
    12: "simbol Uranus di posisi ini dapat menjadi pengingat untuk mengambil jeda dan memperhatikan kebiasaan yang melelahkan pikiran.",
  },
  Neptune: {
  ...
  Pluto: {
    ...
    4: "simbol Pluto di posisi ini dapat mengarahkan perhatian pada dinamika keluarga atau kenyamanan batin yang ingin kamu perjelas.",
    ...
    12: "simbol Pluto di posisi ini dapat menjadi ruang hening untuk menyadari beban pikiran tanpa harus terburu-buru menyimpulkannya.",
  },
  Chiron: {
    ...
    4: "simbol Chiron di posisi ini dapat mengajakmu merenungkan rasa aman di rumah dan bentuk dukungan yang membuatmu nyaman.",
    ...
    7: "simbol Chiron di posisi ini dapat menjadi cermin untuk meninjau kejujuran dan batas yang sehat dalam hubungan terdekat.",
    ...
    12: "simbol Chiron di posisi ini dapat menjadi ajakan lembut untuk meluangkan waktu tenang dan merawat diri dengan wajar.",
  },
};
...
const PLANET_HOUSE_ACTIONS: Record<string, Record<number, string>> = {
  ...
  Uranus: {
    ...
    12: "Tulis satu hal yang ingin kamu lepaskan di secarik kertas, lalu sobek atau simpan sebagai pengingat refleksi pribadimu.",
  },
  Neptune: {
    ...
    6: "Pastikan kebutuhan cairanmu cukup hari ini. Air putih dan makanan segar bisa menjadi pilihan sederhana.",
  ...
  Pluto: {
    ...
    4: "Tulis refleksi singkat tentang perasaanmu saat ini di buku catatan untuk membantu merapikan pikiran.",
  ...
  Chiron: {
    ...
    7: "Beri jeda sejenak untuk meninjau harapanmu dalam hubungan saat ini agar langkahmu terasa lebih tenang.",
